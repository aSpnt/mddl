...
SELECT ed.id as entity_def_id, ed.code as entity_def_code, fd.id as field_def_id, fd.code as field_def_code, fd.field_def_type as field_def_type
...
WHERE fd.entity_def_mode_id is null
ORDER BY ed.code;
