...
import com.aspnt.mddl.converter.base.BaseVersionConverter;
...
import com.aspnt.mddl.service.DictionaryService;
import com.aspnt.mddl.service.ValueExternalService;
import com.aspnt.mddl.utils.DateTimeUtils;
...
import static com.aspnt.mddl.converter.FieldValueUtilsConverter.FIELD_VALUE_COPY;
...
public abstract class EntityConverter implements BaseVersionConverter<Entity, EntityDto> {
    ...
    public abstract BaseSlugRef convertToBaseSlugEntity(Entity entity);
