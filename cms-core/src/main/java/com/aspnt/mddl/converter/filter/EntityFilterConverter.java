package com.aspnt.mddl.converter.filter;

import com.aspnt.mddl.config.ConverterConfig;
import com.aspnt.mddl.dto.api.ExternalApiEntityRequest;
import com.aspnt.mddl.dto.api.ExternalApiFieldFilter;
import com.aspnt.mddl.dto.api.ExternalApiFieldFilterOperation;
import com.aspnt.mddl.dto.api.ExternalApiGlobalFilterOperation;
import com.aspnt.mddl.dto.api.ExternalApiTextSearchFilter;
...
import com.aspnt.mddl.utils.EntityDefUtils;
...
public abstract class EntityFilterConverter {
    ...
    public FilterOperator getOperator(ExternalApiFieldFilterOperation operation) {
     ...
     */
    private FieldFilterDto convertFieldDto(UUID entityDefId, ExternalApiFieldFilter filedFilterRequest) {
    ...
    private FilterGlobalOperator convertOperator(ExternalApiGlobalFilterOperation operation) {
        if (operation == ExternalApiGlobalFilterOperation.OR) {
    ...
    public EntityFilterDto convertToDto(
            ...
            ExternalApiTextSearchFilter textSearch,
            ExternalApiEntityRequest request
    ) {
