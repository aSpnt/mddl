...
import com.aspnt.mddl.service.storage.provider.props.ExternalDictionaryProperties;
...
public class RestEntityStorageProvider implements EntityStorageProvider {
    ...
    @Override
    public BaseSlugRef getBaseSlugEntityByEntityDefAndSlug(String entityDefCode, String entitySlug) {
        return null;
    }
