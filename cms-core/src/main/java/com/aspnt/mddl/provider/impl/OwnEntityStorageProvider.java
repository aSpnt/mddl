package com.aspnt.mddl.provider.impl;
...
import com.aspnt.mddl.dto.filter.FieldFilterBlockDto;
import com.aspnt.mddl.dto.filter.FieldFilterDto;
import com.aspnt.mddl.dto.filter.FieldOrderDto;
import com.aspnt.mddl.dto.filter.FilterGlobalOperator;
import com.aspnt.mddl.dto.filter.FilterOperator;
import com.aspnt.mddl.dto.filter.SearchFilterDto;
import com.aspnt.mddl.entity.Entity;
import com.aspnt.mddl.entity.entitydef.EntityDef;
import com.aspnt.mddl.entity.entitydef.EntityDef_;
import com.aspnt.mddl.entity.Entity_;
import com.aspnt.mddl.entity.ExternalDictionaryValue_;
import com.aspnt.mddl.entity.FieldValue;
import com.aspnt.mddl.entity.FieldValue_;
...
import com.aspnt.mddl.entity.field.FieldDef_;
import com.aspnt.mddl.exception.EntityNotFoundException;
import com.aspnt.mddl.hibernate.ArrayFunctionContributor;
import com.aspnt.mddl.hibernate.FtsFunctionContributor;
import com.aspnt.mddl.provider.EntityStorageProvider;
import com.aspnt.mddl.repository.EntityCommentRepository;
import com.aspnt.mddl.repository.EntityDefRepository;
import com.aspnt.mddl.repository.EntityRepository;
import com.aspnt.mddl.repository.FieldDefRepository;
import com.aspnt.mddl.repository.FieldValueRepository;
import com.aspnt.mddl.security.UserInfo;
...
import static com.aspnt.mddl.hibernate.ArrayFunctionContributor.ARRAY_ANY;
import static com.aspnt.mddl.hibernate.ArrayFunctionContributor.ARRAY_OVERLAP;
...
public class OwnEntityStorageProvider implements EntityStorageProvider {
    ...
    @Override
    public BaseSlugRef getBaseSlugEntityByEntityDefAndSlug(
            String entityDefCode,
            String entitySlug
    ) {
        var entityOpt = entityRepository.findBySlugAndDefType(entitySlug, entityDefCode);
    ...
    @Override
    public List<BaseSlugRef> getSlugListByEntityDefAndIdList(String entityDefCode, List<String> entityIds) {
    ...
    public EntityDto getEntityById(UUID entityDefId, String entityId) {
        return entityRepository.findById(UUID.fromString(entityId))
                ...
                .orElseThrow(() -> new EntityNotFoundException("Entity was not found", entityId));
    }
        ...
        return (root, query, builderSource) -> {
            ...
            if (filter.getSearchFilter() != null && filter.getSearchFilter().getFtsSearch() != null) {
                ...
                if (filter.getFieldOrder() == null && filter.getFixedFieldOrder() == null) {
                    query.orderBy(builder.asc(root.get(Entity_.seq)), builder.asc(root.get(Entity_.id)));
                }
            }
